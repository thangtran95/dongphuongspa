    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <form role="form" action="{{url('admin/price/create-price.html')}}" method="POST" enctype="multipart/form-data">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Thêm Price</h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <div class="col-md-8">
                                    ...
                                    <div class="tab-content">
                                        <div class="active tab-pane" id="vietnam">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="description_vi" required>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Giá (VNĐ)</label>
                                        <input type="text" class="form-control" name="price" onkeyup="return format_currency(this)" required>
                                    </div>
                                    <div class="form-group">
