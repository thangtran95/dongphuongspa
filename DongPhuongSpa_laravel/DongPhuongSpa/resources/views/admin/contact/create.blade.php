    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <form role="form" action="{{url('admin/news/create-news.html')}}" method="POST" enctype="multipart/form-data">
                        <div class="box">
                            ...
                            <div class="box-body">
                                    ...
                                    <div class="tab-content">
                                        <div class="active tab-pane" id="vietnam">
                                            <div class="form-group">
                                                <label>Tiêu đề</label>
                                                <input type="text" class="form-control" name="title_vi" required>
                                            </div>
                                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>
                                                <input type="checkbox" name="is_featured" value="1" class="flat-red" checked>
                                                &nbsp; &nbsp;Nổi bật
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Hình ảnh (600x400)</label>
                                        <img id="imgSlide" src="{{asset('images/news/default.png')}}" class="img-responsive" style="width: 100%" alt="Team Image">
                                        <div class="input-group image-preview" style="margin-top: 10px">
                                            <input id="text-image" type="text" class="form-control image-preview-filename" required disabled="disabled">
