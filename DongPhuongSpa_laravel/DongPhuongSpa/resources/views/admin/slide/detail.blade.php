    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <form role="form" action="{{url('admin/slide/detail-slide')}}/{{$slide->id}}.html" method="POST" enctype="multipart/form-data">
                        <div class="box">
                            ...
                            <div class="box-body">
                                    ...
                                    <div class="tab-content">
                                        <div class="active tab-pane" id="vietnam">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name_vi" value="{{$slide_vi->name}}" required>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="english">
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">Name</label>
                                                <input type="text" class="form-control" name="name_en" value="{{$slide_en->name}}" required>
                                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>
                                                <input type="radio" name="status" value="1" class="flat-red" @if($slide->status == 1) checked @endif>
                                                Hiện
                                            </label>
                                            <label style="margin-left: 30px">
                                                <input type="radio"  name="status" value="0" class="flat-red" @if($slide->status == 0) checked @endif>
                                                Ẩn
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <img id="imgSlide" src="{{asset('images/slide')}}/{{$slide->image}}" class="img-responsive" style="width: 100%" alt="Slide Image">
                                        <div class="input-group image-preview" style="margin-top: 10px">
                                            <input placeholder="" id="text-image" value="{{$slide->image}}" type="text" class="form-control image-preview-filename" disabled="disabled">
