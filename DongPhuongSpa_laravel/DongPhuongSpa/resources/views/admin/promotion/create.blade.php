    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <form role="form" action="{{url('admin/promotion/create-promotion.html')}}" method="POST" enctype="multipart/form-data">
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Hình ảnh (300x300)</label>
                                        <img id="imgSlide" src="{{asset('images/promotion/default.png')}}" class="img-responsive" style="width: 100%" alt="Hình ảnh khuyến mãi">
