    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <form role="form" action="{{url('admin/team/create-team.html')}}" method="POST" enctype="multipart/form-data">
                        <div class="box">
                            ...
                            <div class="box-body">
                                    ...
                                    <div class="tab-content">
                                        <div class="active tab-pane" id="vietnam">
                                            <div class="form-group">
                                                <label>Chức vụ</label>
                                                <input type="text" class="form-control" name="role_vi" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Mô tả</label>
                                        ...
                                        <div class="tab-pane" id="english">
                                            ...
                                            <div class="form-group">
                                                <label>Role</label>
                                                <input type="text" class="form-control" name="role_en" required>
                                            </div>
                                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="sort_order" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Hình ảnh (260x260)</label>
                                        <img id="imgSlide" src="{{asset('images/team/default.png')}}" class="img-responsive" style="width: 260px; height: 260px" alt="Team Image">
